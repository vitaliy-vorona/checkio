...
class SpaceCraft():
    ...
    destinations = {"Mars": ['baza', 'dolina_kraterov'], "Moon": ['baza', 'back_site'],
                    "Earth_Orbit": ['high', 'really_high', 'almost_there'],
                    "Asteroid's_Belt": ['too_dangerous_to_fly_to']}

    space_crafts = {"XSpace": ['Falcon Heavy', 'Falcon 9', 'Dragon'],
    ...
    def _choose_space_craft(self, space_company):
        ...
        try:
            ...
            return "\nError while choosing space craft" \
                   ...
                   .format(space_company, [_ for _ in self.space_crafts.keys()])
    ...
    def _set_target_destination(self, destination=''):
        ...
        if self.space_craft_chosen:
            try:
                ...
                self.target_place = " ... {} destination does not exist".format(destination)
            return "\nChoose any from the following choice: " \
                   .format(_ for _ in self.destinations.keys())
        else:
    ...
    def __str__(self):
        return "\nThe mission current state is: " \
               ...
               "\n\tTarget place is {}" \
            .format(self.space_craft, self.destination, self.target_place)
